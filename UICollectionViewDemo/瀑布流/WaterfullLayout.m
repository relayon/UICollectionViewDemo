...
@implementation WaterfullLayout {
    // 存放每个item的高度
...
- (void)prepareLayout {
    ...
    for (int i = 0; i < itemNumber; i ++) {
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(waterfullHeightForItemAtIndex:)]) {
            itemHeight = [_delegate waterfullHeightForItemAtIndex:indexPath];
        }
